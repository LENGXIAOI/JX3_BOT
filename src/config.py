...
class Jx3ApiConfig(BaseModel, extra=Extra.ignore):
    ...
    api_urlcs: str = Field("", alias="jx3api_urlcs")
    api_urlcss: str = Field("", alias="jx3api_urlcss")
    api_urljyh: str = Field("", alias="jx3api_urljyh")
    """主站的url"""
    api_token: str = Field("", alias="jx3api_token")
    api_tokenyh: str = Field("", alias="jx3apiyh_token")
    api_tokenjyh: str = Field("", alias="jx3apijyh_token")
...
class DefaultConfig(BaseModel, extra=Extra.ignore):
    ...
    """进群欢迎开关"""
    robot_welcome: str = Field(False, alias="defualt_robot_welcome")
    """进群欢迎语"""
    ...
    """群友离开内容"""
    robot_goodnight_status: bool = Field(False, alias="defulat_robot_goodnight_status")
    """晚安通知开关"""
