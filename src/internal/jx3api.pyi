...
class JX3API:
    ...
    async def data_trade_demon(self, *, server: str, limit: int = ...) -> Response:
        ...
        """
        ...
    async def data_trade_market(self, *, server: str, name: str, filter: int = ...) -> Response:
        """
        说明：
            当前时间交易行
        参数:
            * `server`：服务器名
            * `filter`： 单页数量，设置单页返回的数量；默认值 : 10。
        """
        ...
    async def data_server_check(self, *, server: str) -> Response:
        ...
        """
        ...
    async def data_tieba_random(self, *, server: str, token: str, subclass: str, limit: int = ...) -> Response:
        """
        说明：
            服务器当前的状态 [ 已开服/维护中 ]
        参数：
        ...
        """
        ...
    async def data_server_antivice(self, *) -> Response:
        """
        说明：
            查询诛恶事件历史记录
        参数：
        ...
        """
        ...
    async def data_active_celebrities(self, *) -> Response:
        """
        说明：
            查询当前时间的楚天社进度
        参数：
    ...
    async def data_server_status(self, *, server: str) -> Response:
        ...
        """
        ...
    async def data_role_detailed(self, *, name: str, server: str) -> Response:
        """
        说明:
            查询角色信息
        参数:
        ...
        """
        ...
    async def data_save_detailed(self, *, roleId: str, server: str) -> Response:
        """
        说明:
            更新角色信息
        参数:
    ...
    async def data_exam_answer(self, *, question: str, limit: int = ...) -> Response:
        ...
        """
        ...
    async def data_token_web_token(self, *, token: str,) -> Response:
        """
        说明:
            查询挂件的详细属性与效果。
        参数:
        ...
        """
        ...
    async def data_other_pendant(self, *, name: str,) -> Response:
        """
        说明:
            查询挂件的详细属性与效果。
        参数:
        ...
        """
        ...
    async def data_other_event(self, *, server: str = ..., token: str = ...) -> Response:
        """
        说明:
            马场刷新时间
        参数:
    ...
    async def data_school_matrix(self, *, name: str) -> Response:
        ...
        """
        ...
    async def data_school_force(self, *, name: str) -> Response:
        """
        说明:
            职业奇穴效果
        参数:
    ...
    async def data_luck_adventure(
        self, *, server: str, name: str, ticket: str, token: str
    ) -> Response:
        """
        说明:
            角色奇遇触发记录(不保证遗漏)
    ...
    async def data_look_firework(self, *, server: str, name: str) -> Response:
        ...
        """
        ...
    async def data_watch_record(self, *, server: str, name: str) -> Response:
        """
        说明:
            角色烟花燃放记录
        参数:
    ...
    async def data_school_seniority(
        ...
        """
        ...
    async def data_member_student(
        self, *, keyword: str = ..., server: str = ...
    ) -> Response:
        """
        说明:
            拜师信息
        参数:
            * `token`：推栏标识，检查请求权限
            * `keyword`：门派简称，查询指定门派的资历榜单，默认值 : ALL
            * `server`：区服名称，筛选记录，默认值 : ALL
        """
        ...
    async def data_member_teacher(
        self, *, keyword: str = ..., server: str = ...
    ) -> Response:
        """
        说明:
        ...
        """
        ...
    async def data_rank_statistical(self, *, table: str, name: str, server: str) -> Response:
        """
        说明:
            客户端风云榜单
        参数:
            * `table`：榜单类型，
            * `name`：可选范围[名士五十强 老江湖五十强 兵甲藏家五十强 名师五十强 阵营英雄五十强 薪火相传五十强 庐园广记一百强]
            * `server`：区服名称，筛选记录
        """
        ...
    ...
    async def data_chat_tencent(
        ...
        """
        ...
    async def data_chat_mixed(
        self, *, session: str, secretKey: str, name: str, text: str
    ) -> Response:
        """
        说明:
            腾讯云智障聊天
    ...
    #                      VIEW  API
    # ------------------------------------------------------------
    async def view_server_sand((self, *, server: str) -> Response:
        """
        说明：
            图片api，查询阵营沙盘
        参数:
    ...
    async def view_active_current(
        ...
        参数:
            ...
            * `num`：预测时间，预测指定时间内的日常；默认值 : 0
        """
        ...
    async def view_active_calendar(
        self, *, robot: str, cache: int = ..., num: int = ...
    ) -> Response:
        """
        说明:
    ...
    async def view_luck_adventure(
        self, *, server: str, name: str, robot: str, ticket: str = ..., token: str = ...
    ) -> Response:
        """
        说明:
    ...
    async def view_web_announce(self, *, robot: str, cache: int = ...) -> Response:
        ...
        """
        ...
    async def view_valuables_statistical(
        self, *, server: str, name: str, robot: str, cache: int = ...
    ) -> Response:
        """
        说明:
        ...
        """
        ...
    async def view_valuables_collect(
        self, *, server: str, robot: str, cache: int = ...
    ) -> Response:
        """
        说明:
    ...
    async def view_member_recruit(
        ...
        """
        ...
    async def view_active_monster(self, *, server: str, name: str) -> Response:
        """
        说明:
            百战异闻录记录
        参数:
			*`scale`: 网页规模，可设置网页大小，可选范围[1，2]，设置值越大越清晰，图片也会更大
			*`robot`: 机器人昵称，绘制底部版权信息
			*`cache`: 缓存模式，可设置文件缓存，可有效提高响应速度，0 = 关闭，1 = 开启；默认值 : 1
			*`token`: 站点标识，检查请求权限
        """
        ...
    async def view_role_achievement(self, *, server: str, name: str) -> Response:
        """
        说明:
            角色成就进度记录
        参数:
    ...
    async def view_rank_excellent(
        self, *, table: str, name: str, server: str, robot: str, cache: int = ...
    ) -> Response:
        """
        说明:
            图片api，客户端战功榜单
    ...
    async def view_useless_circles(self, *, url: str, text: str) -> Response:
        ...
        """
        ...
    async def view_news_index(self) -> Response:
        """
        说明:
            图片api，每天 60 秒读懂世界
        """
